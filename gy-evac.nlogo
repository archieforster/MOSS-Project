...
<experiments>
  <experiment name="test3" repetitions="1" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <metric>ticks</metric>
    <metric>get-no-active-cars</metric>
    <metric>get-no-walking</metric>
    <metric>get-no-evacuating</metric>
    ...
    <enumeratedValueSet variable="warning-interval-time-mins">
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="evacuation-probability">
      <value value="0.3"/>
    </enumeratedValueSet>
